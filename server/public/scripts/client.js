...
function renderToDOM(tasksArray) {
    ...
    for (let i = 0; i < tasksArray.length; i++) {
        ...
        //delete icon
        row.append(`<td><svg class="bi bi-trash-fill" id = "deleteBtn" data-id = ${task.id} width="1em" height="1em" viewBox="0 0 16 16" fill="#a72f1d" xmlns="http://www.w3.org/2000/svg">
